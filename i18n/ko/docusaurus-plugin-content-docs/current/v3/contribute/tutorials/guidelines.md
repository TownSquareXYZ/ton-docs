...
- 튜토리얼 전체에서 **마크다운을 적절히 사용**하세요. [GitHub의 마크다운 가이드](https://guides.github.com/features/mastering-markdown/)와 [샘플 튜토리얼 구조](/v3/contribute/tutorials/sample-tutorial)를 참조하세요.
