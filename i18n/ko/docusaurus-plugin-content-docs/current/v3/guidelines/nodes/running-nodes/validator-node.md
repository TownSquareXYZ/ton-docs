...
> 일반적으로 최대 부하(평균 부하는 약 100 Mbit/s)를 안정적으로 처리하기 위해서는 최소 1 Gbit/s 연결이 필요합니다.

> 네트워크의 원활한 운영을 위해 IOPS 디스크 요구사항이 매우 중요하다는 점을 검증자들에게 특별히 강조합니다.
...
![이미지](/img/nominator-pool/hot-wallet.png)
...
![지갑 목록](/img/docs/nodes-validator/manual-ubuntu_mytonctrl-wl_ru.png)
