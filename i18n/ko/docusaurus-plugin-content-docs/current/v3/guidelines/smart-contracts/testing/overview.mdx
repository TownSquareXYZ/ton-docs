...
| 성공      | boolean? | Custom Sandbox flag that defines the resulting status of a certain transaction. True if both the compute and the action phases succeeded. Otherwise, False. |
...
- [청사진](/v3/documentation/smart-contacts/getting-started/javascript)
