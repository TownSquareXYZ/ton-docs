...
<버튼 href="https://www.tapps.center/" colorType={'primary'} sizeType={'sm'}>
...
<버튼 href="https://blog.ton.org/ton-ecosystem-evolved-introducing-telegram-apps-center-t-apps-center" colorType={'secondary'} sizeType={'sm'}>
...
텍스트 데이터 수신만으로는 부족하거나 보다 고급스럽고 개인화된 인터페이스가 필요한 경우 **웹_앱** 유형 [인라인 키보드 버튼](https://core.telegram.org/bots/api#inlinekeyboardbutton)을 사용하여 미니 앱을 열 수 있습니다.
