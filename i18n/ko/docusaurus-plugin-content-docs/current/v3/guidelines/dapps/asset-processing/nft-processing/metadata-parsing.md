...
| `image_data`  | 바이너리\*    | 선택 사항 | Either a binary representation of the image for the on-chain layout or base64 for the off-chain layout. |
...
| `description`  | UTF8 문자열  | 선택 사항 | Describes the asset                                                                                                                                                                                                                                                                                                                                                   |
| `image`        | ASCII 문자열 | 선택 사항 | A URI pointing to a resource with a mime type image                                                                                                                                                                                                                                                                                                                   |
| `image_data`   | 바이너리\*    | 선택 사항 | Either a binary representation of the image of an on-chain layout or base64 for off-chain layout                                                                                                                                                                                                                                                                      |
...
| `amount_style` |           | 선택 사항 | Required by external applications to understand the format of displaying the number of tokens. Defined using *n*, *n-of-total*, *%*.                                                                                                                                                                                                  |
