...
| [dns-contract](https://github.com/ton-blockchain/dns-contract) <br /> <small>🪄 Run in WebIDE</small>                                                   | `.ton` 존의 스마트 컨트랙트                                                                                             |
...
| [lockup-wallet-deployment](https://github.com/ton-defi-org/lockup-wallet-deployment) <br /> <small>🪄 Run in WebIDE</small>                                            | 락업 컨트랙트 종단간 배포 및 실행                                                                                |
...
| 컨트랙트                                                                                                                                                                                                       | 설명                                |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| [counter.fc](https://github.com/ton-community/blueprint/blob/main/example/contracts/counter.fc) <br /> <small>🪄 Run in WebIDE</small>                                                     | 주석이 포함된 카운터 스마트 컨트랙트              |
...
| [ton-random](https://github.com/puppycats/ton-random) <br /> <small>🪄 Run in WebIDE</small>                                                                                                               | 온체인에서 난수 생성을 도와주는 두 개의 컨트랙트       |
...
| [Blueprint jetton_minter.fc](https://github.com/liminalAngel/func-blueprint-tutorial/blob/master/6/contracts/jetton_minter.fc) <br /> <small>🪄 Run in WebIDE</small> | 온체인에서 제톤을 민팅하기 위한 스마트 컨트랙트 예제     |
