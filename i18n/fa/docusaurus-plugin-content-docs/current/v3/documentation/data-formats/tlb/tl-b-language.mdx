...
| `some` یا `some#`           | Serialize `crc32(equation) \| 0x80000000`.         |
| `some#_` یا `some$_` یا `_` | Serialize nothing.                                 |
...
- `UInt` - ۲۵۶ بیت
- `Bits` - ۱۰۲۳ بیت
- `uint1` - `uint256` - ۱ - ۲۵۶ بیت
- `int1` - `int257` - ۱ - ۲۵۷ بیت
- `bits1` - `bits1023` - ۱ - ۱۰۲۳ بیت
...
محدودیت‌های مجاز: `E` | `E = E` | `E <= E` | `E < E` | `E >= E` | `E > E` | `E + E` | `E * E` | `E ? E`
...
### استفاده از فیلدهای NAT برای انواع پارامتریزشده
...
- [یک توضیح از نسخه قدیمی TL](https://core.telegram.org/mtproto/TL)
