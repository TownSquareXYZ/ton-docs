...
## الگوریتم برای تصمیم‌گیری در مورد تقسیم یا ادغام
...
- `۰` - حد کمبار نرسیده است.
- `۱` - حد کمبار بیشتر شده است.
- `۲` - حد نرم بیشتر شده است.
- `۳` - حد متوسط بیشتر شده است.
- `۴` - حد سخت بیشتر شده است.
...
### ۴. تصمیم‌گیری برای تقسیم یا ادغام
...
ولیدیتورها با استفاده از فلگ‌های `want_split` و `want_merge` و [پارامترهای پیکربندی ورکچین](/v3/documentation/network/configs/blockchain-configs#param-12) تصمیم به تقسیم یا ادغام شاردها می‌گیرند.
...
- [اوراق سفید](/v3/documentation/whitepapers/overview)
