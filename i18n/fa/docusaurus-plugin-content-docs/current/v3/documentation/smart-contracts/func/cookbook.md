...
فرض کنید می‌خواهیم بررسی کنیم که آیا هر رویدادی مرتبط است. برای این کار از متغیر flag استفاده می‌کنیم. به یاد داشته باشید که در FunC `true` برابر با `-1` و `false` برابر با `0` است.
...
### چگونه تشخیص دهیم که وضعیت قرارداد خالی است
...
### چگونه یک پیام با کل موجودی ارسال کنیم
...
### چگونه دیکشنری‌ها را پیمایش کنیم
