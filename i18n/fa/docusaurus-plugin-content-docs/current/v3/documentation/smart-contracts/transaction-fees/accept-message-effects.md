...
توجه داشته باشید که تنظیمات دستی محدودیت‌های گاز با رفتار برگشتی تداخل نمی‌کنند؛ پیام‌ها برگشت می‌خورند اگر در حالت قابل برگشت ارسال شده و شامل مقدار کافی پول برای پرداخت هزینه‌های پردازش و ایجاد پیام‌های برگشتی باشد.
