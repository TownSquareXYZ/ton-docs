...
| lt_فعلی                                                                                        | blockchain.logicalTime                                                       |                  |
...
[درباره قابلیت تغییر پذیری بخوانید](/v3/documentation/smart-contracts/tolk/tolk-vs-func/mutability).
