...
این مواد آموزشی ارائه شده توسط اکوسیستم TON را برای یکپارچگی بهتر DApp کاوش کنید.

- **ترافیک**. بازدیدهای کاربر اضافی را از طریق کیف پول‌های رمزنگاری که از TON Connect پشتیبانی می‌کنند، هدایت کنید.
...
- **پرداخت‌ها**. تراکنش‌ها را به سرعت و با اطمینان از طریق بلاکچین TON با استفاده از Toncoin یا USD₮ پردازش کنید.
...
- [GetGems — بازار شبکه باز](https://getgems.io/)
- [STON.fi — AMM DEX برای بلاکچین TON](https://ston.fi/)
- [TON Society](https://society.ton.org/activities/active)

<details>
  <summary><b>نمایش لیست کامل</b></summary>
...
برای اتصال خدمات خود به اکوسیستم TON، باید موارد زیر را پیاده‌سازی کنید:

- **TON Connect**. پروتکل TON Connect را در برنامه خود بگنجانید.
- **تراکنش‌ها**. پیام‌های تراکنش مشخص شده را با استفاده از کتابخانه‌های TON ایجاد کنید. به فرآیند [فرستادن پیام‌ها](/v3/guidelines/ton-connect/guidelines/preparing-messages) با راهنمای جامع ما بپردازید.
