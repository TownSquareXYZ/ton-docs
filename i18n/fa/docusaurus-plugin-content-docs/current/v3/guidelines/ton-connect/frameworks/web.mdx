...
رابط کاربری TonConnect یک رابط آشنا و قابل تشخیص برای کاربران هنگام استفاده از برنامه‌های مختلف ارائه می‌دهد. با این حال، توسعه‌دهنده برنامه می‌تواند این رابط را تغییر دهد تا با رابط برنامه منسجم شود.
