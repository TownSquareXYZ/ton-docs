...
> معمولاً برای اطمینان از پاسخگویی به بار اوج، به حداقل 1 Gbit/s اتصال نیاز دارید (انتظار می‌رود بار متوسط حدود 100 Mbit/s باشد).

> توجه ویژه ولیدیتورها را به نیازهای دیسک IOPS می‌طلبیم، که برای عملکرد سریع شبکه حیاتی است.
...
![تصویر](/img/nominator-pool/hot-wallet.png)
...
![لیست کیف پول](/img/docs/nodes-validator/manual-ubuntu_mytonctrl-wl_ru.png)
...
- [رفع مشکل](/v3/guidelines/nodes/nodes-troubleshooting)
