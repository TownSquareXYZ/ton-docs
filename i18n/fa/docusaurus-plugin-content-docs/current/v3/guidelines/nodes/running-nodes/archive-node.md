...
- ترافیک ۱۶ ترابایت در ماه تحت بارگذاری اوج
...
2. تنظیمات ذخیره‌سازی را برای نود در خط `ExecStart` اضافه کنید:
...
:::caution
اگر فرآیند همگام‌سازی نود قبلاً ۵ روز طول کشیده است، اما نود هنوز همگام نیست، باید بخش
[رفع مشکلات](/v3/guidelines/nodes/nodes-troubleshooting#archive-node-is-out-of-sync-even-after-5-days-of-the-syncing-process) را بررسی کنید.
:::

#### شروع نود

1. با اجرای دستور، ولیدیتور را شروع کنید:
