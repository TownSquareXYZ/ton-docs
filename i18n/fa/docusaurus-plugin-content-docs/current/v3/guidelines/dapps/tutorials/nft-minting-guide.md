...
**این مجموعه زیبای اردک‌ها است که تا پایان این آموزش ایجاد خواهید کرد:**
...
4. شما متادیتا را به [pinata.cloud](https://pinata.cloud) بارگذاری خواهید کرد.
...
بیایید با ایجاد یک پروژه خالی شروع کنیم:
...
عالی! اکنون آماده‌ هستیم که شروع به نوشتن کد برای پروژه خود کنیم.
...
یک نمونه کلاس برای تعامل با toncenter ایجاد کنید:
...
| نام                             | توضیح                                                                                                                                                                                 |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| نام                             | NFT name. Recommended length: 15-30 characters                                                                                                        |
| توضیحات                         | توضیحات NFT. طول پیشنهادی: تا ۵۰۰ کاراکتر                                                                                                             |
| تصویر                           | Link to the NFT image.                                                                                                                                                |
| ویژگی‌ها                        | List of NFT attributes, where a trait_type (attribute name) and value (a short description) are specified. |
| لوتی                            | Link to a JSON file with Lottie animation (if specified, the animation will play on the NFT’s page).                                               |
| آدرس_محتوا | لینک به محتوای اضافی.                                                                                                                                                 |
| نوع_محتوا  | Type of content from the content_url link (e.g., video/mp4).                                  |

![تصویر](/img/tutorials/nft/item-metadata.png)
...
هر فایل را مرور کنید و محتوای آن را بدست آورید
...
| نام                                                          | توضیح                                                                                     |
| ------------------------------------------------------------ | ----------------------------------------------------------------------------------------- |
| آدرس_مالک                               | The address set as the collection owner. Only the owner can mint new NFTs |
| درصد_حق‌الامتیاز                        | The percentage of each sale that goes to the specified address                            |
| آدرس_حق‌الامتیاز                        | The wallet address that receives royalties from sales of this NFT collection              |
| شاخص_آیتم_بعدی     | The index assigned to the next NFT item                                                   |
| آدرس_محتوای_مجموعه | The URL of the collection metadata                                                        |
| آدرس_محتوای_مشترک  | he base URL for NFT item metadata                                                         |
