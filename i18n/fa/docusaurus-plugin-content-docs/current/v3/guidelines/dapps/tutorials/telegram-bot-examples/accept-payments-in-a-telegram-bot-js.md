...
در این مقاله، ما یک ربات تلگرام ساده برای پذیرش پرداخت‌ها در TON ایجاد خواهیم کرد.
...
[NodeJS](https://nodejs.org/en/download/) را نصب کنید اگر هنوز این کار را نکرده‌اید.
...
اینجا باید مقادیر رادر چهار خط اول پر کنید:
...
فایل `app.js` را باز کنید و تمامی هندلرها و ماژول‌های مورد نیازمان را وارد کنید.
