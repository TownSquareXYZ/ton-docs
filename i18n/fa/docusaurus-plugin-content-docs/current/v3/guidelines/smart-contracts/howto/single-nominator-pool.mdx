...
1. اعتبارسنجی را متوقف کنید و تمام وجوه را برداشت کنید.
...
2. اعتبارسنجی را متوقف کنید و تمام وجوه را برداشت کنید.
...
3. ایجاد لینک‌های نمادین برای کامپایلرها:
...
(ذخیره آدرس در فایل single-nominator.addr)
...
1. حالت اعتبارسنجی را غیرفعال کنید:
...
9. منتظر رأی‌گیری اعتبارسنج‌ها باشید.
   <Feedback />
