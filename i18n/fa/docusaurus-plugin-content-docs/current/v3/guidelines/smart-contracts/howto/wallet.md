---
description: در این آموزش، شما یاد خواهید گرفت که چگونه به طور کامل با کیف‌پول‌ها، پیام‌ها و قراردادهای هوشمند کار کنید.
---
...
یادگیری چگونگی کارکرد کیف‌پول‌ها و تراکنش‌ها در TON قبل از شروع توسعه قراردادهای هوشمند ضروری است. این دانش به توسعه‌دهندگان کمک می‌کند تا تعامل بین کیف‌پول‌ها، پیام‌ها و قراردادهای هوشمند را درک کرده و وظایف خاص توسعه را پیاده‌سازی کنند.
...
تمام مثال‌های کد استفاده شده در این آموزش را می‌توانید در [مخزن GitHub](https://github.com/aSpite/wallet-tutorial) زیر پیدا کنید.

## ✍️ What you need to get started

- اطمینان حاصل کنید که NodeJS نصب شده است.
- کتابخانه‌های خاص Ton موردنیاز هستند و شامل موارد زیر می‌شوند: @ton/ton 13.5.1+، @ton/core 0.49.2+ و @ton/crypto 3.2.0+.
...
1. یک پوشه خالی ایجاد کنید (که نام آن را WalletsTutorial خواهیم گذاشت).
2. پوشه پروژه را با استفاده از CLI باز کنید.
3. از دستورات زیر برای راه‌اندازی پروژه‌ی خود استفاده کنید:
