...
پیام را دریافت می‌کند، اگر قبلاً استفاده شده باشد، آن را نمی‌پذیرد، در غیر این صورت پیام را به جلو ارسال می‌کند
...
به نظر می‌رسد که یک حلقه اینجا زائد است.
...
خوب، ما به جایی رسیدیم، اما چه درباره بهینه‌سازی‌های Shard؟
