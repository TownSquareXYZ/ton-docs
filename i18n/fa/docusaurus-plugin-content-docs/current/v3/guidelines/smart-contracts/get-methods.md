...
در این مثال، قرارداد با تفسیر کدهای عملیاتی، اجرای متدهای خاص و به‌طور مناسب پاسخ دادن، پیام‌های داخلی را دریافت و پردازش می‌کند:
