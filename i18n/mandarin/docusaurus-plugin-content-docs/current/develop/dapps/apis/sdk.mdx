...
| 库                                                         | 语言         | ADNL连接器类型 |
| --------------------------------------------------------- | ---------- | --------- |
| [ton-kotlin](https://github.com/ton-community/ton-kotlin) | Kotlin     | 原生ADNL    |
| [tonutils-go](https://github.com/xssnick/tonutils-go)     | GO         | 原生ADNL    |
| [tongo](https://github.com/tonkeeper/tongo)               | GO         | 原生ADNL    |
| [tonutils](https://github.com/thekiba/tonutils)           | TypeScript | 原生ADNL    |
