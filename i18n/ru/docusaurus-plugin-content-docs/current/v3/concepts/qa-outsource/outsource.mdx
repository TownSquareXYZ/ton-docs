...
Если вы полностью готовы стать аутсорсинговым агентом для экосистемы TON, то вы можете добавить в список свою компанию заполнив нашу форму или отправив pull request в наш проект.
