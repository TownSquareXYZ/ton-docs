...
- `Timestamp` 64-битное время эпохи unix операции подписи
- `Payload` - это двоичная строка переменной длины.
...
- [[YouTube] Проверка ton_proof для @tonconnect/react-ui [RU]] (https://youtu.be/wIMbkJHv0Fs?list=PLyDBPwv9EPsCJ226xS5_dKmXXxWx1CKz_&t=2971)
