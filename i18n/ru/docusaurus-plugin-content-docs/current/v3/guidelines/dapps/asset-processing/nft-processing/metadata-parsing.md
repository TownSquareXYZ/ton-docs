...
| ------------- | ------------ | ----------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `uri`         | ASCII string | необязательный параметр | A URI pointing to the JSON document with metadata used by the "Semi-chain content layout."              |
| `name`        | UTF8 string  | необязательный параметр | Identifies the asset.                                                                                   |
| `description` | UTF8 string  | необязательный параметр | Describes the asset.                                                                                    |
| `image`       | ASCII string | необязательный параметр | A URI pointing to a resource with a MIME type image.                                                    |
| `image_data`  | binary\*     | необязательный параметр | Either a binary representation of the image for the on-chain layout or base64 for the off-chain layout. |
...
| `description`  | UTF8 string  | необязательный параметр | Describes the asset                                                                                                                                                                                                                                                                                                                                                   |
| `image`        | ASCII string | необязательный параметр | A URI pointing to a resource with a mime type image                                                                                                                                                                                                                                                                                                                   |
| `image_data`   | binary\*     | необязательный параметр | Either a binary representation of the image of an on-chain layout or base64 for off-chain layout                                                                                                                                                                                                                                                                      |
| `symbol`       | UTF8 string  | необязательный параметр | Token symbol - for example, "XMPL" and uses the form "You have received 99 XMPL"                                                                                                                                                                                                                                                                                      |
| `decimals`     | UTF8 string  | необязательный параметр | The number of decimal places used by the token. If not specified, the default is 9. A UTF8-encoded string with numbers from 0 to 255. - for example, 8 means that the token amount must be divided by 100000000 to get its custom representation.                                                     |
| `amount_style` |              | необязательный параметр | Required by external applications to understand the format of displaying the number of tokens. Defined using *n*, *n-of-total*, *%*.                                                                                                                                                                                                  |
| `render_type`  |              | необязательный параметр | Needed by external applications to understand what group a token belongs to and how to display it. "currency" - displays as currency (default). "game" - display used for games, displays as NFT, but also displays the number of tokens and respects the amount_style value. |
