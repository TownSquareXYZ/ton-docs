...
| описание                          | Описание коллекции                                                                                                                                                     |
| изображение                       | Ссылка на изображение, которое будет отображаться как аватар. Поддерживаемые форматы ссылок: https, ipfs, TON Storage. |
...
| Имя                               | Объяснение                                                                                                                                                                                                   |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| имя                               | Название NFT. Рекомендуемая длина: Не более 15-30 символов                                                                                                                   |
| описание                          | Описание NFT. Рекомендуемая длина: До 500 символов                                                                                                                           |
| изображение                       | Ссылка на изображение NFT.                                                                                                                                                                   |
| атрибуты                          | Атрибуты NFT. Список атрибутов, в котором указан тип_черты (имя атрибута) и значение (краткое описание атрибута). |
...
| сумма            | Количество TON, которое будет отправлено в NFT с развертыванием                                                  |
