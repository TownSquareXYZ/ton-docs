...
Прежде чем погружаться в DApps, убедитесь, что Вы понимаете принципы, лежащие в основе блокчейна. Возможно, Вам будут полезны наши статьи [The Open Network](/v3/concepts/dive-into-ton/introduction) и [Блокчейн блокчейнов](/v3/concepts/dive-into-ton/ton-blockchain/blockchain-of-blockchains).

TON DApps - это приложения без бэкенда, которые взаимодействуют с блокчейном. В большинстве случаев они взаимодействуют с пользовательскими [смарт-контрактами](/v3/documentation/smart-contracts/overview); в этой документации представлены способы обработки стандартных ассетов, доступных на TON, как в качестве примера, так и для ускорения разработки DApps.
...
Работаете с ассетами? Эти руководства рассказывают о самом необходимом:
