...
В предыдущих шагах, мы сознательно не объясняли назначение `ctxID` и `ID`, хранимых в состоянии нашего смарт-контракта, и почему они оставались нетронутыми во всех функциях смарт-контракта. Теперь их цель должна стать более ясной.
