...
Добро пожаловать в руководство для быстрого старта в TON-разработке! Здесь вы найдёте отправную точку для погружения в концепции TON, а также базовый опыт разработки приложений в экосистеме TON.
