...
:::caution
Убедитесь, что вы сохранили фразу для восстановления `owner_wallet` в Vesting. Если доступ к `owner_wallet` утерян, доступ к управлению средствами `vesting` будет также утерян и не может быть восстановлен.
:::
...
6. После получения адреса `single_nominator_pool` on-chain, запросите whitelist `single_nominator_pool` у того, кто отправил вам Vesting-контракт.
