...
2. Создайте адрес с которого будет происходить развертывание (адрес диплоера):
...
3. Пополните адрес диплоера на 2.1 TON.
...
Настройте смарт-контракт Single Nominator Pool, используя [следующие](/v3/guidelines/smart-contracts/howto/single-nominator-pool#настройка-single-nominator-pool) инструкции.
