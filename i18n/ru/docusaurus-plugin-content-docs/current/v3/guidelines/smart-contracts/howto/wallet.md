...
Изучение того, как работают кошельки и транзакции на TON, прежде чем приступать к разработке смарт-контрактов, крайне важно. Эти знания помогут разработчикам понять принцип взаимодействия между кошельками, сообщениями и смарт-контрактами для выполнения конкретных задач разработки.
...
В этом разделе мы научимся создавать операции без использования предварительно настроенных функций, чтобы понять процесс разработки. Все ссылки, необходимые для анализа этого урока, находятся в конце раздела.
