...
Прежде чем приступать к разработке смарт-контрактов, крайне важно понять как работают кошельки и транзакции на TON. Это поможет разработчикам понять принцип взаимодействия между кошельками, сообщениями и смарт-контрактами для выполнения конкретных задач разработки.
...
Изучение данного руководства потребует базовых знаний JavaScript и TypeScript или Golang. Также необходимо иметь как минимум 3 TON (которые можно хранить на биржевом счете, в некастодиальном кошельке или в боте Кошелек от Telegram). Для понимания также необходимо иметь базовое представление о [ячейке](/v3/concepts/dive-into-ton/ton-blockchain/cells-as-data-storage), [адресах в TON](/v3/documentation/smart-contracts/addresses), [блокчейне блокчейнов](/v3/concepts/dive-into-ton/ton-blockchain/blockchain-of-blockchains).
