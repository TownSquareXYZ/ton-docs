...
В этом разделе мы узнаем чуть больше о внутренних `internal` и внешних `external` сообщениях, создадим и отправим их в сеть, при этом постараемся свести к минимуму использование заранее подготовленных функций.
