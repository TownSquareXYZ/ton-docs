...
Как только Вы развернете эту систему с помощью сообщения `set_first` с достаточным количеством TON, она будет автоматически выполняться с основными и полезными комбинациями режимов отправки.
...
Транзакция[ID:1] в контракте Fireworks Setter вызывается с помощью `op::set_first` и выполняется с двумя исходящими сообщениями для Fireworks launcher-1 и Fireworks launcher-2
...
Транзакция в Fireworks launcher 1 вызывается с помощью `op::launch_first`, и выполняется с четырьмя исходящими сообщениями в Launcher.
...
Транзакция[ID:3] происходит в Fireworks launcher 1, вызывается с помощью `op::launch_first` и выполняется с четырьмя исходящими сообщениями к Launcher.
...
Транзакция[ID:4] выполняется в Launcher(Deploy Wallet) с входящим сообщением от Fireworks launcher 1. Это сообщение отправлено с `send mode = 0` в транзакции[ID:2].
...
Транзакция[ID:5] выполняется в Launcher с входящим сообщением от Fireworks launcher 1. Это сообщение отправлено с `send mode = 1`
...
Транзакция[ID:6] выполняется в Launcher с входящим сообщением от Fireworks launcher 1. Это сообщение отправлено с параметром `send mode = 2`
...
Транзакция[ID:7] выполняется в Launcher с входящим сообщением от Fireworks launcher 1. Это сообщение отправлено с параметром `send mode = 128 + 32`
...
Транзакция[ID:8] выполняется в Launcher с входящим сообщением от Fireworks launcher 2. Это сообщение отправлено с параметром `send mode = 64`
