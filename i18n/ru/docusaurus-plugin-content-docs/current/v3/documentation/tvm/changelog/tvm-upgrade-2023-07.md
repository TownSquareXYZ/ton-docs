...
| `RIST255_QVALIDATE` | *`x - 0 или -1`*       | Quiet version of `RIST255_VALIDATE`.<br/>*234 gas*.                                                                     |
| `RIST255_QADD`      | *`x y - 0 или x+y -1`* | Quiet version of `RIST255_ADD`. <br/>*634 gas*.                                                                         |
| `RIST255_QSUB`      | *`x y - 0 или x-y -1`* | Quiet version of `RIST255_SUB`.<br/>*634 gas*.                                                                          |
| `RIST255_QMUL`      | *`x n - 0 или x*n -1`* | Quiet version of `RIST255_MUL`.<br/>*2034 gas*.                                                                         |
| `RIST255_QMULBASE`  | *`n - 0 или g*n -1`*   | Quiet version of `RIST255_MULBASE`.<br/>*784 gas*.                                                                      |
...
| `BLS_G1_INGROUP`  | *`x - bool`*                                    | Checks whether the slice `x` represents a valid element of G1.<br/>*2984 gas*.                                                                                                                                                                                   |
