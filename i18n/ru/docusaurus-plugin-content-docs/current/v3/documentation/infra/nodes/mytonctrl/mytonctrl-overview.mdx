...
| Формат имени                 | Формат                                                                     | Пример                                                                | Description                                                                     |
| :--------------------------- | :------------------------------------------------------------------------- | :-------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| Без аргументов               | `update`                                                                   | `update`                                                              | Update from current repo                                                        |
...
| Формат имени                 | Формат                                                                      | Пример                                                              | Description                                                                           |
| :--------------------------- | :-------------------------------------------------------------------------- | :------------------------------------------------------------------ | ------------------------------------------------------------------------------------- |
| Без аргументов               | `upgrade`                                                                   | `upgrade`                                                           | Upgrade from current repo                                                             |
...
| Формат имени   | Формат        | Пример        | Description                                                                                                                     |
| -------------- | ------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Без аргументов | `status`      | `status`      | Full status report including validator efficiency and online validators.                                                        |
...
| Format name         | Формат           | Description                                                                                 |
| ------------------- | ---------------- | ------------------------------------------------------------------------------------------- |
...
| Формат имени                          | Формат                              | Description                                                                  |
| ------------------------------------- | ----------------------------------- | ---------------------------------------------------------------------------- |
| Без аргументов                        | `el`                                | Prints the table with ADNL, Pubkey, and Wallet reduced.                      |
| Любая комбинация следующих аргументов | `el --json adnl pubkey wallet past` | Full ADNL, Pubkey, Wallet, and past election entries in JSON representation. |
...
| Формат имени                          | Format                              | Description                                                                   |
| ------------------------------------- | ----------------------------------- | ----------------------------------------------------------------------------- |
| Без аргументов                        | `vl`                                | Prints the table with ADNL, Pubkey, and Wallet reduced.                       |
| Любая комбинация следующих аргументов | `vl --json adnl pubkey wallet past` | Full ADNL, Pubkey, Wallet, and past validator entries in JSON representation. |
