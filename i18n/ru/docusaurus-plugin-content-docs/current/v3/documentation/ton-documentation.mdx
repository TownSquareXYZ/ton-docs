...
Пройти курс по основам блокчейна
...
Если вы только начинаете разрабатывать на блокчейне TON, рекомендуем начать с основ и последовательно изучить эти темы.

### Основные концепции

- [The Open Network](/v3/concepts/dive-into-ton/introduction) - Подробный обзор блокчейна TON.
- [Блокчейн блокчейнов](/v3/concepts/dive-into-ton/ton-blockchain/blockchain-of-blockchains) - Простое и понятное объяснение блокчейна TON.
...
Децентрализованные приложения (DApp) — это приложения, которые работают в одноранговой сети компьютеров (например, в блокчейне TON), а не на одном сервере. Они напоминают традиционные веб-приложения, но функционируют на базе блокчейна. Это означает, что DApp децентрализованы, то есть не контролируются какой-либо одной организацией.
...
Ознакомьтесь с [Часто задаваемыми вопросами](/v3/documentation/faq).
