...
| :---------------------------------------------------------------------------------------------------- | :------------- | :------------------------------------------ |
| Total fee                                                                                             | 0.001982134    | газ + хранение + действие + импорт          |
| Fwd. fee                                                                                              | 0.001          | fwd_fee + action_fee + ihr_fee              |
| Gas fee                                                                                               | 0.0011976      | фаза вычислений, использованный газ         |
| Storage fee                                                                                           | 0.000000003    | фаза хранения, только аккаунт               |
| Action fee                                                                                            | 0.000133331    | фаза действий, стоимость за действие        |
| Import fee (hidden)                                                                                   | 0.0006512      | cost of import of in_ext_msg                |
| [Forward fee](/v3/documentation/smart-contracts/transaction-fees/fees-low-level#formula-1) (each msg) | 0.000266669    | стоимость fwd in_msg                        |
| [IHR fee](/v3/documentation/smart-contracts/transaction-fees/fees-low-level#ihr) (each msg)           | 0.0006         | стоимость ihr fwd in_msg                    |
