...
| Contest                  | Задачи                                                                                                       | Решения                                                                                                                           |
| ------------------------ | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------- |
| TSC #5 (Dec 2023)        | [Tasks](https://github.com/ton-community/tsc5/)                                                              |                                                                                                                                   |
| TSC #4 (Sep 2023)        | [Tasks](https://github.com/ton-community/tsc4/)                                                              | [Решения](/v3/documentation/smart-contracts/contracts-specs/examples#ton-smart-challenge-4)                                       |
