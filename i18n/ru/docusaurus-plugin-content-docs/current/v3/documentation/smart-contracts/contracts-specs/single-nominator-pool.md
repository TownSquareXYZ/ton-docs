...
Если у вас есть single nominator, который располагает всеми ставками для валидации, это самая надежная схема, которую можно использовать. Помимо простоты, этот смарт-контракт предоставляет владельцу множество аварийных защит, которые могут восстановить ставку в таких ситуациях, как обновление *Избирателя*, которое ломает интерфейс восстановления ставки.
