...
| 0x8B           | Операция добавления расширения была не успешной                                                                                 |
| 0x8C           | Операция удаления расширения была не успешной                                                                                   |
...
:::info
Также оп-код, опкод и операционный код
:::
...
| Jetton-Minter | 0xcb862902            | Метаданные изменения Jetton                                                                                                                                                                                                                                            |
| Jetton-Minter | 0x2508d66a            | Модернизация Jetton                                                                                                                                                                                                                                                    |
| Vesting       | 0xd372158c            | [пополнить счет] (https://github.com/ton-blockchain/liquid-staking-contract/blob/be2ee6d1e746bd2bb0f13f7b21537fb30ef0bc3b/PoolConstants.ts#L28) |
| Vesting       | 0x7258a69b            | Добавить белый список                                                                                                                                                                                                                                                  |
| Vesting       | 0xf258a69b            | Добавить ответ в белый список                                                                                                                                                                                                                                          |
| Vesting       | 0xa7733acd            | Отправить                                                                                                                                                                                                                                                              |
| Vesting       | 0xf7733acd            | Отправить ответ                                                                                                                                                                                                                                                        |
| Dedust        | 0x9c610de3            | Dedust Swap ExtOut                                                                                                                                                                                                                                                     |
| Dedust        | 0xe3a0d482            | Dedust Swap Jetton                                                                                                                                                                                                                                                     |
| Dedust        | 0xea06185d            | Dedust Swap Internal                                                                                                                                                                                                                                                   |
| Dedust        | 0x61ee542d            | Сменные внешние                                                                                                                                                                                                                                                        |
| Dedust        | 0x72aca8aa            | Обмен равными                                                                                                                                                                                                                                                          |
| Dedust        | 0xd55e4686            | Внутренняя ликвидность депозитов                                                                                                                                                                                                                                       |
| Dedust        | 0x40e108d6            | Ликвидность депозитов Jetton                                                                                                                                                                                                                                           |
| Dedust        | 0xb56b9598            | Ликвидность депозитов все                                                                                                                                                                                                                                              |
...
- [Работа со смарт-контрактами Wallet](/v3/guidelines/smart-contracts/howto/wallet)
