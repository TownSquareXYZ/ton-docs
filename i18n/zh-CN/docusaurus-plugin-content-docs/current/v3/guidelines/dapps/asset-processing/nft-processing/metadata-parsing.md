...
| 属性            | 类型        | 要求 | 描述                                                                                                                      |
| ------------- | --------- | -- | ----------------------------------------------------------------------------------------------------------------------- |
| `uri`         | ASCII 字符串 | 可选 | A URI pointing to the JSON document with metadata used by the "Semi-chain content layout."              |
| `name`        | UTF8 字符串  | 可选 | Identifies the asset.                                                                                   |
| `description` | UTF8 字符串  | 可选 | Describes the asset.                                                                                    |
| `image`       | ASCII 字符串 | 可选 | A URI pointing to a resource with a MIME type image.                                                    |
| `image_data`  | 二进制\*     | 可选 | Either a binary representation of the image for the on-chain layout or base64 for the off-chain layout. |
...
| `description`  | UTF8 字符串  | 可选 | Describes the asset                                                                                                                                                                                                                                                                                                                                                   |
| `image`        | ASCII 字符串 | 可选 | A URI pointing to a resource with a mime type image                                                                                                                                                                                                                                                                                                                   |
| `image_data`   | 二进制\*     | 可选 | Either a binary representation of the image of an on-chain layout or base64 for off-chain layout                                                                                                                                                                                                                                                                      |
| `symbol`       | UTF8 字符串  | 可选 | Token symbol - for example, "XMPL" and uses the form "You have received 99 XMPL"                                                                                                                                                                                                                                                                                      |
...
| `amount_style` |           | 可选 | Required by external applications to understand the format of displaying the number of tokens. Defined using *n*, *n-of-total*, *%*.                                                                                                                                                                                                  |
