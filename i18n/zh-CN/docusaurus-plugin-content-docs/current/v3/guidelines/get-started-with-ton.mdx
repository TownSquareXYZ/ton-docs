...
- 激活[Tonkeeper 钱包内的测试网络模式](/v3/concepts/dive-into-ton/ton-ecosystem/wallet-apps#tonkeeper-test-environment)
- 将 Tonkeeper 中的 testnet 钱包地址输入到 `./scripts/mine.ts` 中的 `walletAddress` 变量中
