...
- **Cross-contract verification:** contract *A* can verify transactions on contract *B* without B’s cooperation.
...
| `RIST255_QVALIDATE` | *`x - 0 或 -1`*       | Quiet version of `RIST255_VALIDATE`.<br/>*234 gas*.                                                                     |
| `RIST255_QADD`      | *`x y - 0 或 x+y -1`* | Quiet version of `RIST255_ADD`. <br/>*634 gas*.                                                                         |
| `RIST255_QSUB`      | *`x y - 0 或 x-y -1`* | Quiet version of `RIST255_SUB`.<br/>*634 gas*.                                                                          |
| `RIST255_QMUL`      | *`x n - 0 或 x*n -1`* | Quiet version of `RIST255_MUL`.<br/>*2034 gas*.                                                                         |
| `RIST255_QMULBASE`  | *`n - 0 或 g*n -1`*   | Quiet version of `RIST255_MULBASE`.<br/>*784 gas*.                                                                      |
...
| `BLS_AGREGATE`            | *`sig_1 ... sig_n n - sig`*                | Aggregates signatures. `n>0`. Throws an exception if `n=0` or if any `sig_i` is invalid .<br/>*`gas=n*4350-2616`*.                                                     |
| `BLS_FASTAGREGATEVERIFY`- | *`pk_1 ... pk_n n msg sig - bool`*         | Checks an aggregated BLS signature for keys `pk_1...pk_n` and a message `msg`. It returns false if `n=0`.<br/>*`gas=58034+n*3000`*.                                                    |
| `BLS_AGREGATEVERIFY`      | *`pk_1 msg_1 ... pk_n msg_n n sgn - bool`* | Checks an aggregated BLS signature for multiple key-message pairs `pk_1 msg_1...pk_n msg_n`. Returns true if valid, false otherwise. Returns false if `n=0`.<br/>*`gas=38534+n*22500`* |
...
| `BLS_G1_INTROUP`  | *`x - bool`*                                    | Checks whether the slice `x` represents a valid element of G1.<br/>*2984 gas*.                                                                                                                                                                                   |
...
| `BLS_G2_INTROUP`  | *`x - bool`*                                    | Checks whether the slice `x` represents a valid element of G2.<br/>*4284 gas*.                                                                                                                                                                                   |
