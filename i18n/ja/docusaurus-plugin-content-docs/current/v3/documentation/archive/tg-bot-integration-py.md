...
:::warning 旧式
このガイドでは、TelegramボットとTON Connectを統合する古い方法について説明します。よりモダンで安全な統合のためには、[Telegram Mini Apps](/v3/guidelines/dapps/tma/overview) の利用をご検討ください。
:::
...
`.env`ファイルに[ボットトークン](https://t.me/BotFather) を指定し、TON Connectの[マニフェストファイル](https://github.com/ton-connect/sdk/tree/main/packages/sdk#add-the-tonconnect-manifest)にリンクします。これらを `config.py` でロードします：
