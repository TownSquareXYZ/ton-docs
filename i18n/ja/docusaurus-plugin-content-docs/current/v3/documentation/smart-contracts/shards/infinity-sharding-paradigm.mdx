...
バリデーターは、`want_split` および `want_merge` フラグと [ワークチェーン構成パラメーター](/v3/documentation/network/configs/blockchain-configs#param-12) を使用してシャードを分割またはマージするかを決定します。
...
- [ホワイトペーパー](/v3/documentation/whitepapers/overview)
