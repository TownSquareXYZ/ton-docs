...
価格フィードへのインターフェースとして機能し、価格データの取得と更新を処理します。
...
以下の例ではテストネットコントラクトを使用しています。メインネットで使用する場合は、`PYTH_CONTRACT_ADDRESS_TESTNET` を `PYTH_CONTRACT_ADDRESS_MAINNET` に変更してください。 
