---
description: このチュートリアルでは、ウォレット、メッセージ、スマートコントラクトの使い方を学びます。
---
...
スマートコントラクトの開発を開始する前に、ウォレットとトランザクションがどのようにTON上で動作するかを学ぶことが不可欠です。 この知識は、開発者がウォレット、メッセージ、スマートコントラクト間の相互作用を理解し、特定の開発タスクを実装するのに役立ちます。
...
このチュートリアルで使用されるすべてのコード例は、以下の [GitHub リポジトリ](https://github.com/aSpite/wallet-tutorial) にあります。

## ✍️ What you need to get started

- NodeJSがインストールされていることを確認します。
- 特定の Ton ライブラリが必要です。@ton/ton 13.5.1+、@ton/core 0.49.2+、@ton/crypto 3.2.0+。
...
1. 空のフォルダ（WalletsTutorial）を作成します。
2. CLI を使用してプロジェクトフォルダーを開きます。
3. 次のコマンドを使用してプロジェクトを設定します。
