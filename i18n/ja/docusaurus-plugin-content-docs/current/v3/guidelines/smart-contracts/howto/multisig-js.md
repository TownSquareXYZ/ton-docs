---
description: このガイドの最後にマルチシグウォレットを展開し、tonライブラリを使用してトランザクションを送信します。
---

import Feedback from '@site/src/components/Feedback';

# TypeScriptを使用してマルチシグウォレットとやりとりします
...
- [低レベルマルチシグガイド](/v3/guidelines/smart-contracts/howto/multisig)
- [ton.js Documentation](https://ton-community.github.io/ton/)
- [マルチシグコンタクトソース](https://github.com/ton-blockchain/multisig-contract)
