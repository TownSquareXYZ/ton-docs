...
1. 好みのコード・エディタまたは IDE で index.html を開きます。
...
そして、Telegram Botを作成する必要があります。これにより、メッセンジャーアプリケーション内でTelegram Mini Appを起動できます。
...
![Screenshot 2023-09-11 at 18.58.24.png](/img/docs/telegram-apps/moderng)
