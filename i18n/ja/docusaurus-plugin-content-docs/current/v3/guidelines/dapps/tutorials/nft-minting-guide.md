...
**このチュートリアルが終わるころには、このような素晴らしいアヒルのコレクションができあがります。**
...
4. メタデータを [pinata.cloud](https://pinata.cloud) にアップロードします。
...
素晴らしい！これでプロジェクトのコードを書き始める準備ができた。
...
toncenter と対話するクラスインスタンスを作成します：
...
| 名称       | コレクション名                                                                                                                |
| 記述       | コレクション概要                                                                                                               |
| イメージ     | Link to the avatar image. Supported formats: https, ipfs, TON Storage. |
| カバー画像    | Link to the collection cover image.                                                                    |
| ソーシャルリンク | List of up to 10 links to the project's social media profiles.                                         |

![画像](/img/tutorials/nft/collection-metadata.png)
...
| 名称       | 説明                                                                                                                                                                                    |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 名称       | NFT name. Recommended length: 15-30 characters                                                                                                        |
| 記述       | NFTの説明推奨される長さ：500文字以内                                                                                                                                                                 |
| イメージ     | Link to the NFT image.                                                                                                                                                |
| 属性       | List of NFT attributes, where a trait_type (attribute name) and value (a short description) are specified. |
| ロッティ     | Link to a JSON file with Lottie animation (if specified, the animation will play on the NFT’s page).                                               |
| コンテンツURL | 追加コンテンツへのリンク                                                                                                                                                                          |
| コンテンツタイプ | Type of content from the content_url link (e.g., video/mp4).                                  |

![画像](/img/tutorials/nft/item-metadata.png)
...
| 名称              | 説明                                                                                        |
| --------------- | ----------------------------------------------------------------------------------------- |
| オーナーアドレス        | The address set as the collection owner. Only the owner can mint new NFTs |
| ロイヤリティ・パーセント    | The percentage of each sale that goes to the specified address                            |
| ロイヤリティアドレス      | The wallet address that receives royalties from sales of this NFT collection              |
| nextItemIndex   | The index assigned to the next NFT item                                                   |
| コレクション・コンテンツURL | The URL of the collection metadata                                                        |
| 共通コンテンツURL      | he base URL for NFT item metadata                                                         |
