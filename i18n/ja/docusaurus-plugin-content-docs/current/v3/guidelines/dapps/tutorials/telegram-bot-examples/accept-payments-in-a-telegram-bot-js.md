---
description: チュートリアルの最後には、TONで直接プロダクトの支払いを受け付けることができる素晴らしいボットを書くことができます。
---
...
まだの方は[NodeJS](https://nodejs.org/en/download/)をインストールしてください。
...
`app.js`ファイルを開き、必要なハンドラとモジュールをすべてインポートします。
