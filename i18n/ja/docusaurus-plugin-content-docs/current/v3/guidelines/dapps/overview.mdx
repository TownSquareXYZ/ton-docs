...
アセットを扱うこれらのガイドでは、基本的なことを説明しています：

- [Payments processing](/v3/guidelines/dapps/asset-processing/payments-processing)
- [Token (jetton) processing](/v3/guidelines/dapps/asset-processing/jettons)
- format@@0(/v3/guidelines/dapps/asset-processing/nft-processing/nfts)
...
- format@@0(/v3/documentation/dapps/defi/coins)
...
- [例](https://github.com/xssnick/tonutils-go/tree/master/example)
...
- [デスクトップスタンダードウォレット（C++およびQt）](https://github.com/ton-blockchain/wallet-desktop)
- [Androidスタンダードウォレット(Java)](https://github.com/ton-blockchain/wallet-android)
- [iOSスタンダードウォレット(Swift)](https://github.com/ton-blockchain/wallet-ios)
