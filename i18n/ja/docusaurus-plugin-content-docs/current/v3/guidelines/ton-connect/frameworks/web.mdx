...
接続後にユーザーを特定の URL にリダイレクトするには、[リターン戦略のカスタマイズ](https://github.com/ton-connect/sdk/tree/main/packages/ui#add-the-return-strategy) を使用します。

#### Telegram ミニアプリ

ウォレット接続後、[Telegram Mini App](/v3/guidelines/dapps/tma/overview)にユーザーをリダイレクトするには、`twaReturnUrl`オプションを使用します。
...
[SDKドキュメントで詳しく理解する](https://github.com/ton-connect/sdk/tree/main/packages/ui#use-inside-twa-telegram-web-app)

### UI のカスタマイズ

TonConnect UIは、さまざまなアプリを使用するときに使い慣れた、認識できるインターフェイスを提供します。 ただし、アプリ開発者はこのインターフェイスを変更して、アプリのインターフェイスと一貫性を保つことができます。

- [TonConnect UI documentation](https://github.com/ton-connect/sdk/tree/main/packages/ui#ui-customization)

## SDK documentation

- [SDK documentation](https://github.com/ton-connect/sdk/blob/main/packages/ui/README.md)
- [最新のAPIドキュメント](https://ton-connect.github.io/sdk/modules/_tonconnect_ui.html)
...
TON 接続を使用してメッセージに署名して検証する方法を理解してください:

- [Signing and verification](/v3/guidelines/ton-connect/guidelines/verifying-signed-in-users)
- [TON Connect UI implementation on GitHub](https://github.com/ton-connect/sdk/tree/main/packages/ui#add-connect-request-paramers-ton_proof)
